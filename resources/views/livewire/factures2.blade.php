        <div class="py-12">
            <div class="flex justify-center border-b-2 pb-5">
                <img class="block h-24 w-auto" src="/images/logo.png" alt="logo">
                ...
                <div class="text-center border-l-2 ml-3 pl-3 pt-3">
                    ...
                    <div class="flex flex-col mt-8 text-xs">
                        <table class="mb-6 mx-auto">
                            ...
                            $plans = App\Models\Plan::whereIn('id', $plans)->get()
                            @endphp
                        ...
                        <x-jet-button class="w-2 mx-auto" wire:click="validerFacture"></x-jet-button>
                    </div>
                </div>
            </div>
        </div>
